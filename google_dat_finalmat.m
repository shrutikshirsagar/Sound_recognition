...
class = {'Door_knock', 'Fireengine', 'Ding-dong','Doorbell','Policecar','Firealarm','smoke_detector','Civildefense_siren','carhorn','Baby_cry'};
path_in_ = '//media/amrgaballah/Backup_Plus/Internship_exp/google_audioset_features/feat_3/'
path_out_ = '//media/amrgaballah/Backup_Plus/Internship_exp/google_audioset_features/feat_3_final/'




for c = 1:length(class)
    path_in = [path_in_ class{c} '/'];
    path_out = [path_out_ class{c} '/'];
    ...
    filename_ = strcat(class{c}, '.mat')
    save(fullfile(path_out,filename_), 'feat_fin')
end
