...
in_dir_name='//media/amrgaballah/Backup_Plus/Internship_exp/google_audioset 2/Emergency_vehicle/';
% in_dir_name = './sounds'
% Change this to the directory where you would like the output to go (the
% structures saved as .mat files)
out_dir_name='//media/amrgaballah/Backup_Plus/Internship_exp/google_audioset_features/feat_3/Emergency_vehicle'
...
config_s.Harmonic.threshold_harmo = 0.01;
