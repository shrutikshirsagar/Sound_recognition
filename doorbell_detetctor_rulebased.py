...
##Step 2: Based on the rmse value make a rule for detection of the region of interest for doorbell features. Algorithm for selection of starting and ending time of doorbell when it crosses zero, raised a flag for starting feature extraction get a start time and then stop flag as soon as it goes to negative value than the end time of doorbell sound. 
##Step 3: Once we get a region of interest, calculate features for the doorbell: pitch, harmonics, harmonic ratio, Spectral centroid, spectral bandwidth, spectral flatness, duration, the entropy of energy, skewness, and kurtosis of energy. 
...
filename = '//media/amrgaballah/Backup_Plus/Internship_exp/Exp_1/final_training/ding_dong/18665 standard ding dong-full.wav'
...
###### SStep 2: Based on the rmse value make a rule for detection of the region of interest for doorbell features. Algorithm for selection of starting and ending time of doorbell when it crosses zero, raised a flag for starting feature extraction get a start time and then stop flag as soon as it goes to negative value than the end time of doorbell sound.
...
df_final.to_csv('//media/amrgaballah/Backup_Plus/Internship_exp/doorbell_ex1.csv',index=None)   
